...
exports.customLaunchers = {
    ...
    'Chrome_1024x768': {
        base: 'Chrome',
        chromeDataDir: '/usr/local/google/home/jelbourn/.config/google-chrome/Default',
...
var sauceAliases = {
    'ALL': Object.keys(exports.customLaunchers).filter(function (item) {
        return exports.customLaunchers[item].base == 'SauceLabs';
    }),
...
var browserstackAliases = {
    'ALL': Object.keys(exports.customLaunchers).filter(function (item) {
        return exports.customLaunchers[item].base == 'BrowserStack';
    }),
...
function buildConfiguration(type, target, required) {
    return Object.keys(configuration)
        .map(function (item) { return [item, configuration[item][type]]; })
        .filter(function (_a) {
        var item = _a[0], conf = _a[1];
