# 9.0.0-rc.2 "butane-bonanza" (2019-11-12)
...
| bug fix |  **overlay:** maxWidth and maxHeight not applied when using ex… ([#17586](https://github.com/angular/components/issues/17586)) ([969d5c2](https://github.com/angular/components/commit/969d5c2)), closes [#17582](https://github.com/angular/components/issues/17582) |
| bug fix |  **popover-edit:** incorrect spacing for form field inside pop… ([#17600](https://github.com/angular/components/issues/17600)) ([790b53e](https://github.com/angular/components/commit/790b53e)) |
...
| bug fix |  **slider:** some potentially broken styles when using css var… ([#17580](https://github.com/angular/components/issues/17580)) ([584ad3f](https://github.com/angular/components/commit/584ad3f)) |
| bug fix |  **slider:** track fill not rendering on ios safari when slide… ([#17583](https://github.com/angular/components/issues/17583)) ([fa18ce1](https://github.com/angular/components/commit/fa18ce1)) |
| bug fix |  **stepper:** not rendering correctly in some cases when step… ([#17555](https://github.com/angular/components/issues/17555)) ([cd7d8c8](https://github.com/angular/components/commit/cd7d8c8)) |
...
| bug fix |  **mdc-chips:** chip set not picking up… ([#17568](https://github.com/angular/components/issues/17568)) ([e7aeee4](https://github.com/angular/components/commit/e7aeee4)) |
