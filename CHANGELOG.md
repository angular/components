...
|            |                       |
| ---------- | --------------------- |
| bug fix |  **chips:** avoid accidental form submits when pressing remove… ([#18095](https://github.com/angular/components/issues/18095)) ([3b4e496](https://github.com/angular/components/commit/3b4e496)) |
| bug fix |  **datepicker:** not respecting form control updateOn: blur fo… ([#18063](https://github.com/angular/components/issues/18063)) ([61029c8](https://github.com/angular/components/commit/61029c8)), closes [#16461](https://github.com/angular/components/issues/16461) |
...
| bug fix |  **sidenav:** move focus into sidenav in side mode if autoFocu… ([#17995](https://github.com/angular/components/issues/17995)) ([c9856ee](https://github.com/angular/components/commit/c9856ee)), closes [#17967](https://github.com/angular/components/issues/17967) |
...
|            |                       |
| ---------- | --------------------- |
| bug fix |  **mdc-chips:** avoid potential server-s… ([#18044](https://github.com/angular/components/issues/18044)) ([17a7bcb](https://github.com/angular/components/commit/17a7bcb)) |
| bug fix |  **mdc-chips:** checkmark not visible in… ([#18061](https://github.com/angular/components/issues/18061)) ([99af8e9](https://github.com/angular/components/commit/99af8e9)) |
| bug fix |  **mdc-chips:** error on IE and Edge due… ([#18074](https://github.com/angular/components/issues/18074)) ([5fccd24](https://github.com/angular/components/commit/5fccd24)) |
| bug fix |  **mdc-chips:** prevent default space an… ([#18084](https://github.com/angular/components/issues/18084)) ([7b7e633](https://github.com/angular/components/commit/7b7e633)) |
| bug fix |  **mdc-chips:** remove aria-hidden from… ([#18054](https://github.com/angular/components/issues/18054)) ([55ee988](https://github.com/angular/components/commit/55ee988)) |
| bug fix |  **mdc-chips:** removed chip still focus… ([#18083](https://github.com/angular/components/issues/18083)) ([403377d](https://github.com/angular/components/commit/403377d)) |
| bug fix |  **mdc-slide-toggle:** fix extra border… ([#18035](https://github.com/angular/components/issues/18035)) ([b989701](https://github.com/angular/components/commit/b989701)) |
| bug fix |  **mdc-slide-toggle:** initial checked a… ([#17991](https://github.com/angular/components/issues/17991)) ([e746895](https://github.com/angular/components/commit/e746895)) |
...
| feature |  initial prototype of mdc-form-fie… ([#17903](https://github.com/angular/components/issues/17903)) ([697c3a0](https://github.com/angular/components/commit/697c3a0)) |
