...
describe('MdCalendar', () => {
  ...
  describe('standard calendar', () => {
    ...
    it('should be in month view with specified month active', () => {
      ...
      expect(calendarInstance._activeDate).toEqual(new Date(2017, 0, 31));
    });
    ...
    it('should go to next and previous month', () => {
      ...
      expect(calendarInstance._activeDate).toEqual(new Date(2017, 1, 28));

      prevButton.click();
      fixture.detectChanges();

      expect(calendarInstance._activeDate).toEqual(new Date(2017, 0, 28));
    });
    ...
    it('should go to previous and next year', () => {
      ...
      expect(calendarInstance._activeDate).toEqual(new Date(2018, 0, 31));
    ...
    it('should go back to month view after selecting month in year view', () => {
      ...
      expect(calendarInstance._monthView).toBe(true, 'should be in month view');
      expect(calendarInstance._activeDate).toEqual(new Date(2017, 11, 31));
      ...
      describe('calendar body', () => {
        ...
        describe('month view', () => {
          it('should decrement date on left arrow press', () => {
            ...
            expect(calendarInstance._activeDate).toEqual(new Date(2017, 0, 30));

            calendarInstance._activeDate = new Date(2017, 0, 1);
            fixture.detectChanges();

            dispatchKeyboardEvent(calendarBodyEl, 'keydown', LEFT_ARROW);
            fixture.detectChanges();

            expect(calendarInstance._activeDate).toEqual(new Date(2016, 11, 31));
          });
          ...
          it('should increment date on right arrow press', () => {
            ...
            expect(calendarInstance._activeDate).toEqual(new Date(2017, 1, 1));

            dispatchKeyboardEvent(calendarBodyEl, 'keydown', RIGHT_ARROW);
            fixture.detectChanges();

            expect(calendarInstance._activeDate).toEqual(new Date(2017, 1, 2));
          });
          ...
          it('should go up a row on up arrow press', () => {
            ...
            expect(calendarInstance._activeDate).toEqual(new Date(2017, 0, 24));

            calendarInstance._activeDate = new Date(2017, 0, 7);
            fixture.detectChanges();
          ...
          it('should go down a row on down arrow press', () => {
            ...
            expect(calendarInstance._activeDate).toEqual(new Date(2017, 1, 7));

            dispatchKeyboardEvent(calendarBodyEl, 'keydown', DOWN_ARROW);
            fixture.detectChanges();

            expect(calendarInstance._activeDate).toEqual(new Date(2017, 1, 14));
          });
          ...
          it('should go to beginning of the month on home press', () => {
            ...
            expect(calendarInstance._activeDate).toEqual(new Date(2017, 0, 1));
          ...
          it('should go to end of the month on end press', () => {
            calendarInstance._activeDate = new Date(2017, 0, 10);
          ...
          it('should go back one month on page up press', () => {
            ...
            expect(calendarInstance._activeDate).toEqual(new Date(2016, 10, 30));
          });
          ...
          it('should go forward one month on page down press', () => {
            ...
            expect(calendarInstance._activeDate).toEqual(new Date(2017, 2, 28));
          });
          ...
          it('should select active date on enter', () => {
            ...
            expect(testComponent.selected).toEqual(new Date(2017, 0, 30));
          });
        });
        ...
        describe('year view', () => {
          ...
          it('should go up a row on up arrow press', () => {
            ...
            expect(calendarInstance._activeDate).toEqual(new Date(2016, 7, 31));

            calendarInstance._activeDate = new Date(2017, 6, 1);
            fixture.detectChanges();

            dispatchKeyboardEvent(calendarBodyEl, 'keydown', UP_ARROW);
            fixture.detectChanges();

            expect(calendarInstance._activeDate).toEqual(new Date(2016, 6, 1));

            calendarInstance._activeDate = new Date(2017, 11, 10);
            fixture.detectChanges();

            dispatchKeyboardEvent(calendarBodyEl, 'keydown', UP_ARROW);
            fixture.detectChanges();

            expect(calendarInstance._activeDate).toEqual(new Date(2017, 4, 10));
          });
          ...
          it('should go down a row on down arrow press', () => {
            ...
            expect(calendarInstance._activeDate).toEqual(new Date(2017, 7, 31));

            calendarInstance._activeDate = new Date(2017, 5, 1);
            fixture.detectChanges();

            dispatchKeyboardEvent(calendarBodyEl, 'keydown', DOWN_ARROW);
            fixture.detectChanges();

            expect(calendarInstance._activeDate).toEqual(new Date(2018, 5, 1));

            calendarInstance._activeDate = new Date(2017, 8, 30);
            fixture.detectChanges();

            dispatchKeyboardEvent(calendarBodyEl, 'keydown', DOWN_ARROW);
            fixture.detectChanges();

            expect(calendarInstance._activeDate).toEqual(new Date(2018, 1, 28));
          });
          ...
          it('should go back one year on page up press', () => {
            calendarInstance._activeDate = new Date(2016, 1, 29);
            fixture.detectChanges();

            dispatchKeyboardEvent(calendarBodyEl, 'keydown', PAGE_UP);
            fixture.detectChanges();

            expect(calendarInstance._activeDate).toEqual(new Date(2015, 1, 28));

            dispatchKeyboardEvent(calendarBodyEl, 'keydown', PAGE_UP);
            fixture.detectChanges();

            expect(calendarInstance._activeDate).toEqual(new Date(2014, 1, 28));
          });
  ...
  describe('calendar with min and max date', () => {
    ...
    it('should clamp startAt value below min date', () => {
      ...
      expect(calendarInstance._activeDate).toEqual(new Date(2016, 0, 1));
    });
    ...
    it('should clamp startAt value above max date', () => {
      ...
      expect(calendarInstance._activeDate).toEqual(new Date(2018, 0, 1));
    });
    ...
    it('should not go back past min date', () => {
      ...
      expect(calendarInstance._activeDate).toEqual(new Date(2016, 1, 1));
    ...
    it('should not go forward past max date', () => {
      ...
      expect(calendarInstance._activeDate).toEqual(new Date(2017, 11, 1));
  ...
  describe('calendar with date filter', () => {
    ...
    describe('a11y', () => {
      ...
      it('should allow entering month view at disabled month', () => {
        ...
        calendarInstance._activeDate = new Date(2017, 10, 1);
        fixture.detectChanges();
...
class CalendarWithDateFilter {
  ...
  dateFilter (date: Date) {
    return date.getDate() % 2 == 0 && date.getMonth() != 10;
  }
}
