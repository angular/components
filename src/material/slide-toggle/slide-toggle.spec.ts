...
describe('MatSlideToggle without forms', () => {
  ...
  describe('basic behavior', () => {
    ...
    it('should have a focus indicator', fakeAsync(() => {
         ...
         expect(slideToggleRippleNativeElement.classList.contains('mat-focus-indicator'))
             .toBe(true);
       }));
  });
  ...
  describe('custom template', () => {
    ...
    it('should be able to set the tabindex via the native attribute', fakeAsync(() => {
         ...
         const slideToggle =
             fixture.debugElement.query(By.directive(MatSlideToggle))!.componentInstance as
             MatSlideToggle;
    ...
    it('should set the tabindex of the host element to -1', fakeAsync(() => {
         ...
         const slideToggle =
             fixture.debugElement.query(By.directive(MatSlideToggle))!.nativeElement;
  ...
  describe('without label', () => {
    ...
    beforeEach(fakeAsync(() => {
      ...
      slideToggleBarElement =
          slideToggleDebugEl.query(By.css('.mat-slide-toggle-bar'))!.nativeElement;
    }));
  ...
  describe('label margin', () => {
    ...
    beforeEach(fakeAsync(() => {
      ...
      slideToggleBarElement =
          fixture.debugElement.query(By.css('.mat-slide-toggle-bar'))!.nativeElement;
    ...
    it('should report changes to NgModel before emitting change event', fakeAsync(() => {
         ...
         spyOn(fixture.componentInstance, 'onChange').and.callFake(() => {
           expect(fixture.componentInstance.checked)
               .withContext(
                   'Expected the model value to have changed before the change event fired.')
               .toBe(true);
         });
...
@Component({template: `<mat-slide-toggle [(ngModel)]="modelValue"></mat-slide-toggle>`})
...
@Component({template: `<mat-slide-toggle>{{label}}</mat-slide-toggle>`})
...
@Component({template: `<mat-slide-toggle><some-text></some-text></mat-slide-toggle>`})
