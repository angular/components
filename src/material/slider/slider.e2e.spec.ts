...
// /** Clicks on the MatSlider at the coordinates corresponding to the given value. */
// async function slideToValue(slider: ElementFinder, value: number): Promise<void> {
//   const webElement = await slider.getWebElement();
//   const endCoords = await getCoordsForValue(slider, value);
//   return await browser.actions().dragAndDrop(webElement, endCoords).perform();
// }
