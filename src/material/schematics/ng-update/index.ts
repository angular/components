...
function renameComponentTokens(): Rule {
  const tokenPrefixes = [
    ...
    {old: '--mat-filled-button', replacement: '--matButton-filled'},
    ...
    {old: '--mat-legacy-button-toggle', replacement: '--matButton-toggle-legacy'},
    ...
    {old: '--mat-outlined-button', replacement: '--matButton-outlined'},
    ...
    {old: '--mat-protected-button', replacement: '--matButton-protected'},
    {old: '--mat-secondary-navigation-tab', replacement: '--mat-tab'},
    {old: '--mat-standard-button-toggle', replacement: '--matButton-toggle'},
    ...
    {old: '--mat-text-button', replacement: '--matButton-text'},
    {old: '--mat-tonal-button', replacement: '--matButton-tonal'},
  ];
  return tree => {
    tree.visit(path => {
      if (shouldRenameTokens(path)) {
