...
import {Component, ViewChild, Type, Provider, ɵZONELESS_ENABLED} from '@angular/core';
...
describe('MDC-based MatPaginator', () => {
  function createComponent<T>(type: Type<T>, providers: Provider[] = []): ComponentFixture<T> {
    TestBed.configureTestingModule({
      ...
      providers: [{provide: ɵZONELESS_ENABLED, useValue: false}, MatPaginatorIntl, ...providers],
      declarations: [type],
    }).compileComponents();
