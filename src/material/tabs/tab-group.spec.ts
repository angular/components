  ...
  describe('basic behavior', () => {
    ...
    it('should emit focusChange on arrow key navigation', () => {
      ...
      const tabLabelContainer =
          fixture.debugElement.query(By.css('.mat-tab-label-container'))!.nativeElement as
          HTMLElement;
