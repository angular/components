...
import {MatSimpleSnackBarInterface, SimpleSnackBar} from './simple-snack-bar';
...
export class MatSnackBar implements OnDestroy {
  ...
  protected simpleSnackBarComponent: Type<MatSimpleSnackBarInterface> = SimpleSnackBar;
  ...
  open(message: string, action: string = '', config?: MatSnackBarConfig):
      MatSnackBarRef<MatSimpleSnackBarInterface> {
