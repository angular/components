...
import {MAT_SELECT_CONFIG, MatSelect, MatSelectConfig} from './select';
import {
    ...
    describe('accessibility', () => {
      ...
      describe('for options', () => {
        ...
        it('should set aria-selected on each option for multi-select', fakeAsync(() => {
             ...
             trigger =
                 multiFixture.debugElement.query(By.css('.mat-select-trigger'))!.nativeElement;
             trigger.click();
             multiFixture.detectChanges();
