  ...
  describe('flat tree', () => {
    describe('should initialize', () => {
      ...
      it('with the right data', () => {
        ...
        expectFlatTreeToMatch(
            treeElement, 28, [`topping_1 - cheese_1 + base_1`], [`topping_2 - cheese_2 + base_2`],
        ...
        expectFlatTreeToMatch(
            treeElement, 28, [`topping_1 - cheese_1 + base_1`], [`topping_2 - cheese_2 + base_2`],
            [`topping_3 - cheese_3 + base_3`], [`_, topping_4 - cheese_4 + base_4`]);
      });
    });
    ...
    describe('with toggle', () => {
      ...
      it('should expand/collapse the node', () => {
        ...
        expectFlatTreeToMatch(
            treeElement, 40, [`topping_1 - cheese_1 + base_1`], [`topping_2 - cheese_2 + base_2`],
            [`topping_3 - cheese_3 + base_3`]);
    ...
    describe('with when node template', () => {
      ...
      it('with the right data', () => {
        expectFlatTreeToMatch(
            treeElement, 28, [`topping_1 - cheese_1 + base_1`], [`topping_2 - cheese_2 + base_2`],
            [`topping_3 - cheese_3 + base_3`], [`>>> topping_4 - cheese_4 + base_4`]);
      });
    });
  });
...
function expectFlatTreeToMatch(
    treeElement: Element, expectedPaddingIndent: number = 28, ...expectedTree: any[]) {
