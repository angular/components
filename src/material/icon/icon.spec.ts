...
describe('MatIcon', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: MAT_ICON_LOCATION, useValue: {getPathname: () => fakePath}},
        {
  ...
  it('should apply class based on color attribute', () => {
    ...
    expect(sortedClassNames(matIconElement)).toEqual([
      'mat-icon', 'mat-primary', 'material-icons', 'notranslate'
    ]);
  });
  ...
  it('should apply a class if there is no color', () => {
    ...
    expect(sortedClassNames(matIconElement)).toEqual([
      'mat-icon', 'mat-icon-no-color', 'material-icons', 'notranslate'
    ]);
  });
  ...
  describe('Ligature icons', () => {
    ...
    it('should use alternate icon font if set', () => {
      ...
      fixture.detectChanges();
      expect(sortedClassNames(matIconElement)).toEqual([
        'mat-icon', 'mat-icon-no-color', 'myfont', 'notranslate'
      ]);
    });
  ...
  describe('Icons from HTML string', () => {
    ...
    it('should prepend the current path to attributes with `url()` references', fakeAsync(() => {
      ...
      `));
         ...
         // return different quotes through `getAttribute`, while some even omit the quotes
         // altogether.
    ...
    it('should update the `url()` references when the path changes', fakeAsync(() => {
      ...
      `));
         ...
         expect(circle.getAttribute('filter'))
             .toMatch(/^url\(['"]?\/\$different-path#blur['"]?\)$/);
       }));
  });
  ...
  describe('custom fonts', () => {
    it('should apply CSS classes for custom font and icon', () => {
      ...
      fixture.detectChanges();
      expect(sortedClassNames(matIconElement)).toEqual([
        'font1', 'house', 'mat-icon', 'mat-icon-no-color', 'notranslate'
      ]);
      ...
      fixture.detectChanges();
      expect(sortedClassNames(matIconElement)).toEqual([
        'f2', 'igloo', 'mat-icon', 'mat-icon-no-color', 'notranslate'
      ]);
      ...
      fixture.detectChanges();
      expect(sortedClassNames(matIconElement)).toEqual([
        'f3', 'mat-icon', 'mat-icon-no-color', 'notranslate', 'tent'
      ]);
    });
    ...
    it('should handle values with extraneous spaces being passed in to `fontSet`', () => {
      ...
      expect(sortedClassNames(matIconElement)).toEqual([
        'font', 'mat-icon', 'mat-icon-no-color', 'notranslate'
      ]);
      ...
      expect(sortedClassNames(matIconElement)).toEqual([
        'changed', 'mat-icon', 'mat-icon-no-color', 'notranslate'
      ]);
    });
    ...
    it('should handle values with extraneous spaces being passed in to `fontIcon`', () => {
      ...
      expect(sortedClassNames(matIconElement)).toEqual([
        'font', 'mat-icon', 'mat-icon-no-color', 'material-icons', 'notranslate'
      ]);
      ...
      expect(sortedClassNames(matIconElement)).toEqual([
        'changed', 'mat-icon', 'mat-icon-no-color', 'material-icons', 'notranslate'
      ]);
    });
  });
  ...
  describe('Icons resolved through a resolver function', () => {
    ...
    it('should fall back to second resolver if the first one returned null', fakeAsync(() => {
         iconRegistry.addSvgIconResolver(() => null)
