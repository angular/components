...
import {_supportsShadowDom, Platform, PlatformModule} from '@angular/cdk/platform';
import {
...
describe('MatInput without forms', () => {
     ...
     fakeAsync(() => {
       ...
       const hintLabel =
           fixture.debugElement.query(By.css(
               '.mat-hint:not(.mat-form-field-hint-end)'))!.nativeElement;
       const endLabel =
           fixture.debugElement.query(By.css('.mat-hint.mat-form-field-hint-end'))!.nativeElement;
       const input = fixture.debugElement.query(By.css('input'))!.nativeElement;
  ...
  it('should update empty class when value changes programmatically and OnPush', fakeAsync(() => {
       ...
       expect(label.classList)
           .withContext('Input initially empty')
           .toContain('mat-form-field-empty');
  ...
  it('should use the native input value when determining whether ' +
     ...
     fakeAsync(() => {
       const fixture =
           createComponent(MatInputWithCustomAccessor, [], [], [CustomMatInputAccessor]);
       fixture.detectChanges();
...
describe('MatInput with appearance', () => {
  ...
  it('should calculate the gap when starting off in RTL', fakeAsync(() => {
       ...
       const outlineFixture = createComponent(
           MatInputWithAppearanceAndLabel,
           [{provide: Directionality, useValue: {change: new Subject<Direction>(), value: 'rtl'}}]);
  ...
  it('should calculate the outline gaps if the element starts off invisible', fakeAsync(() => {
       ...
       let zone: MockNgZone;
       const invisibleFixture = createComponent(
...
function createComponent<T>(
  ...
  TestBed
      .configureTestingModule({
        imports: [
          FormsModule, MatFormFieldModule, MatInputModule, BrowserAnimationsModule, PlatformModule,
