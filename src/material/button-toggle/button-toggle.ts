...
export class MatButtonToggleGroup implements ControlValueAccessor, OnInit, AfterContentInit {
  ...
  @Output()
  readonly change: EventEmitter<MatButtonToggleChange> = new EventEmitter<MatButtonToggleChange>();

  constructor(
      private _changeDetector: ChangeDetectorRef,
      @Optional() @Inject(MAT_BUTTON_TOGGLE_DEFAULT_OPTIONS) defaultOptions?:
   ...
   */
  _syncButtonToggle(
      toggle: MatButtonToggle, select: boolean, isUserInput = false, deferEvents = false) {
...
export class MatButtonToggle extends _MatButtonToggleBase implements OnInit, AfterViewInit,
  ...
  constructor(
      ...
      private _focusMonitor: FocusMonitor, @Attribute('tabindex') defaultTabIndex: string,
      @Optional() @Inject(MAT_BUTTON_TOGGLE_DEFAULT_OPTIONS) defaultOptions?:
          MatButtonToggleDefaultOptions) {
    super();
