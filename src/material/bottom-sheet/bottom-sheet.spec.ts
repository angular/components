...
describe('MatBottomSheet', () => {
  ...
  it('should open a bottom sheet with a template', () => {
    ...
    const bottomSheetRef = bottomSheet.open(
        templateRefFixture.componentInstance.templateRef, {data: {value: 'Knees'}});
  ...
  it('should be able to set a custom aria-label', () => {
    bottomSheet.open(PizzaMsg, {ariaLabel: 'Hello there', viewContainerRef: testViewContainerRef});
    viewContainerFixture.detectChanges();
  ...
  describe('passing in data', () => {
    it('should be able to pass in data', () => {
      const config = {data: {stringParam: 'hello', dateParam: new Date()}};
  ...
  describe('disableClose option', () => {
    it('should prevent closing via clicks on the backdrop', fakeAsync(() => {
         bottomSheet.open(PizzaMsg, {disableClose: true, viewContainerRef: testViewContainerRef});
  ...
  describe('hasBackdrop option', () => {
    it('should have a backdrop', () => {
      bottomSheet.open(PizzaMsg, {hasBackdrop: true, viewContainerRef: testViewContainerRef});
    ...
    it('should not have a backdrop', () => {
      bottomSheet.open(PizzaMsg, {hasBackdrop: false, viewContainerRef: testViewContainerRef});
  ...
  describe('backdropClass option', () => {
    it('should have default backdrop class', () => {
      bottomSheet.open(PizzaMsg, {backdropClass: '', viewContainerRef: testViewContainerRef});
  ...
  describe('focus management', () => {
    ...
    it('should create a focus trap if autoFocus is disabled', fakeAsync(() => {
         ...
         const focusTrapAnchors =
             overlayContainerElement.querySelectorAll('.cdk-focus-trap-anchor');
    ...
    it('should focus the first tabbable element of the bottom sheet on open when' +
       ...
       fakeAsync(() => {
         bottomSheet.open(
             PizzaMsg, {viewContainerRef: testViewContainerRef, autoFocus: 'first-tabbable'});
    ...
    it('should focus the bottom sheet element on open when autoFocus is set to ' +
       ...
       fakeAsync(() => {
         ...
         let container = overlayContainerElement.querySelector('.mat-bottom-sheet-container') as
             HTMLInputElement;
    ...
    it('should focus the first element that matches the css selector on open when ' +
       ...
       fakeAsync(() => {
         bottomSheet.open(
             ContentElementDialog, {viewContainerRef: testViewContainerRef, autoFocus: 'p'});
    ...
    it('should re-focus trigger element when bottom sheet closes', fakeAsync(() => {
         ...
         expect(document.activeElement!.id)
             .not.toBe(
                 'bottom-sheet-trigger', 'Expected the focus to change when sheet was opened.');
    ...
    it('should be able to disable focus restoration', fakeAsync(() => {
         ...
         const bottomSheetRef = bottomSheet.open(
             PizzaMsg, {viewContainerRef: testViewContainerRef, restoreFocus: false});
         ...
         expect(document.activeElement!.id)
             .not.toBe(
                 'bottom-sheet-trigger', 'Expected the trigger not to be refocused on close.');
...
describe('MatBottomSheet with parent MatBottomSheet', () => {
  ...
  beforeEach(
      inject([MatBottomSheet, OverlayContainer], (bs: MatBottomSheet, oc: OverlayContainer) => {
...
describe('MatBottomSheet with default options', () => {
  ...
  beforeEach(fakeAsync(() => {
    const defaultConfig:
        MatBottomSheetConfig = {hasBackdrop: false, disableClose: true, autoFocus: 'dialog'};
  ...
  beforeEach(
      inject([MatBottomSheet, OverlayContainer], (b: MatBottomSheet, oc: OverlayContainer) => {
        bottomSheet = b;
        overlayContainerElement = oc.getContainerElement();
      }));
...
class PizzaMsg {
  constructor(
      public bottomSheetRef: MatBottomSheetRef<PizzaMsg>, public injector: Injector,
...
@Component({template: '', providers: [MatBottomSheet]})
