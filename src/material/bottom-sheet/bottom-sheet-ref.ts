    ...
    if (!this._afterDismissed.closed) {
      ...
      this.containerInstance._animationStateChanged
          ...
          .subscribe(event => {
            ...
            // the specified amount of time plus 100ms. We don't need to run this outside the
            // NgZone, because for the vast majority of cases the timeout will have been cleared
            // before it has fired.
