...
/** @title CDK Datepicker with different locale */
@Component({
  selector: 'cdk-datepicker-locale-example',
  templateUrl: 'cdk-datepicker-locale-example.html',
  styleUrls: ['cdk-datepicker-locale-example.css'],
  providers: [
