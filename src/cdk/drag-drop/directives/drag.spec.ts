...
describe('CdkDrag', () => {
  function createComponent<T>(
    ...
    if (encapsulation != null) {
      TestBed.overrideComponent(componentType, {set: {encapsulation}});
    }
  ...
  describe('standalone draggable', () => {
    describe('mouse dragging', () => {
      ...
      it('should preserve the previous `transform` value', fakeAsync(() => {
           ...
           expect(dragElement.style.transform)
               .toBe('translate3d(50px, 100px, 0px) translateX(-50%)');
         }));
      ...
      it('should not generate multiple own `translate3d` values', fakeAsync(() => {
           ...
           dragElementViaMouse(fixture, dragElement, 50, 100);
           expect(dragElement.style.transform)
               .toBe('translate3d(50px, 100px, 0px) translateY(-50%)');

           dragElementViaMouse(fixture, dragElement, 100, 200);
           expect(dragElement.style.transform)
               .toBe('translate3d(150px, 300px, 0px) translateY(-50%)');
         }));
    ...
    it('should include the drag distance in the ended event', fakeAsync(() => {
         ...
         expect(event).toEqual(
             {source: jasmine.anything(), distance: {x: 25, y: 30}, dropPoint: {x: 25, y: 30}});
         ...
         expect(event).toEqual(
             {source: jasmine.anything(), distance: {x: 40, y: 50}, dropPoint: {x: 40, y: 50}});
       }));
    ...
    it('should allow for the position constrain logic to be customized', fakeAsync(() => {
         const fixture = createComponent(StandaloneDraggable);
         const spy =
             jasmine.createSpy('constrain position spy').and.returnValue({x: 50, y: 50} as Point);
         ...
         expect(spy).toHaveBeenCalledWith(
             jasmine.objectContaining({x: 300, y: 300}), jasmine.any(DragRef));
    ...
    it('should be able to configure the drag input defaults through a provider', fakeAsync(() => {
         ...
         const fixture = createComponent(
             PlainStandaloneDraggable, [{provide: CDK_DRAG_CONFIG, useValue: config}]);
         fixture.detectChanges();
    ...
    it('should not throw if touches and changedTouches are empty', fakeAsync(() => {
         ...
         Object.defineProperties(
             event, {touches: {get: () => []}, changedTouches: {get: () => []}});
  ...
  describe('draggable with a handle', () => {
    ...
    it('should be able to use more than one handle to drag the element', fakeAsync(() => {
         ...
         const dragElement = fixture.componentInstance.dragElement.nativeElement;
         const handles =
             fixture.componentInstance.handles.map(handle => handle.element.nativeElement);
  ...
  describe('in a drop container', () => {
    ...
    it('should dispatch the `dropped` event when an item has been dropped', fakeAsync(() => {
         ...
         dragElementViaMouse(
             fixture, firstItem.element.nativeElement, thirdItemRect.left + 1,
             thirdItemRect.top + 1);
         flush();
         fixture.detectChanges();
    ...
    it('should expose whether an item was dropped outside of a container', fakeAsync(() => {
         ...
         dragElementViaMouse(
             fixture, firstItem.element.nativeElement, containerRect.right + 10,
    ...
    it('should not move items in a vertical list if the pointer is too far away', fakeAsync(() => {
         ...
         dragElementViaMouse(
             fixture, firstItem.element.nativeElement, thirdItemRect.right + 1000,
             thirdItemRect.top + 1);
         flush();
         fixture.detectChanges();
    ...
    it('should not move the original element from its initial DOM position', fakeAsync(() => {
         ...
         dragElementViaMouse(
             fixture, fixture.componentInstance.dragItems.first.element.nativeElement,
    ...
    it('should dispatch the correct `dropped` event in RTL horizontal drop zone', fakeAsync(() => {
         const fixture = createComponent(
             ...
             [{provide: Directionality, useValue: ({value: 'rtl', change: observableOf()})}]);
         ...
         dragElementViaMouse(
             fixture, firstItem.element.nativeElement, thirdItemRect.right - 1,
             thirdItemRect.top + 1);
         flush();
         fixture.detectChanges();
    ...
    it('should calculate the index if the list is scrolled while dragging inside the shadow DOM',
       fakeAsync(() => {
         ...
         const fixture = createComponent(
             DraggableInScrollableVerticalDropZone, [], undefined, [], ViewEncapsulation.ShadowDom);
         fixture.detectChanges();
         const dragItems = fixture.componentInstance.dragItems;
         const firstItem = dragItems.first;
         const thirdItemRect = dragItems.toArray()[2].element.nativeElement.getBoundingClientRect();
    ...
    it('should calculate the index if the viewport is scrolled while dragging', fakeAsync(() => {
         ...
         for (let i = 0; i < 200; i++) {
           fixture.componentInstance.items.push(
               {value: `Extra item ${i}`, height: ITEM_HEIGHT, margin: 0});
         }
    ...
    it('should be able to configure the preview z-index', fakeAsync(() => {
         const fixture = createComponent(
             DraggableInDropZone,
             [{provide: CDK_DRAG_CONFIG, useValue: {dragStartThreshold: 0, zIndex: 3000}}]);
         fixture.detectChanges();
         const item = fixture.componentInstance.dragItems.toArray()[1].element.nativeElement;
         startDraggingViaMouse(fixture, item);
    ...
    it('should create the preview inside the fullscreen element when in fullscreen mode',
       fakeAsync(() => {
        ...
        const fixture = createComponent(
            DraggableInDropZone, [{provide: DOCUMENT, useFactory: () => fakeDocument}]);
        fixture.detectChanges();
        const item = fixture.componentInstance.dragItems.toArray()[1].element.nativeElement;
    ...
    it('should update the boundary if the page is scrolled while dragging', fakeAsync(() => {
         ...
         scrollTo(0, 10);
         let listRect =
             list.getBoundingClientRect();  // Note that we need to measure after scrolling.
    ...
    it('should update the boundary if a parent is scrolled while dragging inside the shadow DOM',
       fakeAsync(() => {
         ...
         const fixture = createComponent(
             DraggableInScrollableParentContainer, [], undefined, [], ViewEncapsulation.ShadowDom);
         fixture.componentInstance.boundarySelector = '.cdk-drop-list';
         fixture.detectChanges();
         ...
         const preview =
             fixture.nativeElement.shadowRoot.querySelector('.cdk-drag-preview')! as HTMLElement;
         let previewRect = preview.getBoundingClientRect();
    ...
    it('should preserve checked state for radio inputs in the content', fakeAsync(() => {
         ...
         expect(previewRadioInput.checked)
             .toBeTruthy(
         ...
         expect(placeholderRadioInput.checked)
             .toBeTruthy(
    ...
    it('should pick out the `transform` duration if multiple properties are being transitioned',
       fakeAsync(() => {
         ...
         expect(preview.parentNode)
             .withContext(
                 'Expected preview to be removed from the DOM at the end of the ' +
    ...
    it('should be able to constrain the preview position with a custom function', fakeAsync(() => {
         ...
         expect(spy).toHaveBeenCalledWith(
             jasmine.objectContaining({x: 200, y: 200}), jasmine.any(DragRef));
    ...
    it('should should be able to disable auto-scrolling', fakeAsync(() => {
         ...
         startDraggingViaMouse(fixture, item);
         dispatchMouseEvent(
             document, 'mousemove', listRect.left + listRect.width / 2,
    ...
    it('should auto-scroll up if the user holds their pointer at top edge', fakeAsync(() => {
         ...
         startDraggingViaMouse(fixture, item);
         dispatchMouseEvent(
             document, 'mousemove', listRect.left + listRect.width / 2, listRect.top);
         fixture.detectChanges();
         tickAnimationFrames(20);
    ...
    it('should auto-scroll right if the user holds their pointer at right edge', fakeAsync(() => {
         ...
         startDraggingViaMouse(fixture, item);
         dispatchMouseEvent(
             document, 'mousemove', listRect.left + listRect.width,
    ...
    it('should auto-scroll left if the user holds their pointer at left edge', fakeAsync(() => {
         ...
         startDraggingViaMouse(fixture, item);
         dispatchMouseEvent(
             document, 'mousemove', listRect.left, listRect.top + listRect.height / 2);
         fixture.detectChanges();
         tickAnimationFrames(20);
    ...
    it('should be able to auto-scroll a parent container', fakeAsync(() => {
         ...
         startDraggingViaMouse(fixture, item);
         dispatchMouseEvent(
             document, 'mousemove', containerRect.left + containerRect.width / 2,
    ...
    it('should not pick up items from descendant drop lists', fakeAsync(() => {
         ...
         expect(innerClasses)
             .not.toContain(draggingClass, 'Expected inner list to start off as not dragging.');
         expect(outerClasses)
             .not.toContain(draggingClass, 'Expected outer list to start off as not dragging.');
    ...
    it('should be able to re-enable a disabled drop list', fakeAsync(() => {
         ...
         const tryDrag = () => {
           const firstItem = dragItems.first;
           const thirdItemRect =
               dragItems.toArray()[2].element.nativeElement.getBoundingClientRect();
           dragElementViaMouse(
               fixture, firstItem.element.nativeElement, thirdItemRect.left + 1,
               thirdItemRect.top + 1);
           flush();
    ...
    it('should be able to configure the drop input defaults through a provider', fakeAsync(() => {
         ...
         const fixture = createComponent(
             PlainStandaloneDropList, [{provide: CDK_DRAG_CONFIG, useValue: config}]);
         fixture.detectChanges();
    ...
    it('should be able to start dragging again if the dragged item is destroyed', fakeAsync(() => {
         ...
         // will throw an error since the element isn't in its original parent. Skip this test if
         // the component hasn't been compiled with Ivy since the assertions depend on the element
         // being removed while dragging.
  ...
  describe('in a connected drop container', () => {
    ...
    it('should call the `enterPredicate` with the item and the container it is entering',
       fakeAsync(() => {
         ...
         dragElementViaMouse(
             fixture, dragItem.element.nativeElement, targetRect.left + 1, targetRect.top + 1);
         flush();
         fixture.detectChanges();
    ...
    it('should be able to start dragging after an item has been transferred', fakeAsync(() => {
         ...
         const element = groups[0][1].element.nativeElement;
         const dropZone =
             fixture.componentInstance.dropInstances.toArray()[1].element.nativeElement;
    ...
    it('should not throw when entering from the top with an intermediate sibling present',
       fakeAsync(() => {
         ...
         expect(() => {
           dragElementViaMouse(
               fixture, item.element.nativeElement, targetRect.left, targetRect.top);
           flush();
           fixture.detectChanges();
         }).not.toThrow();
       }));
    ...
    it('should return DOM element to its initial container after it is dropped, in a container ' +
       ...
       fakeAsync(() => {
         ...
         const dropContainers =
             fixture.componentInstance.dropInstances.map(drop => drop.element.nativeElement);
    ...
    it('should be able to move the item over an intermediate container before ' +
       ...
       fakeAsync(() => {
         ...
         dispatchMouseEvent(
             document, 'mousemove', intermediateRect.left + 1, intermediateRect.top + 1);
         fixture.detectChanges();
    ...
    it('should return the item to its initial position, if sorting in the source container ' +
       ...
       fakeAsync(() => {
         ...
         dispatchMouseEvent(
             document, 'mousemove', firstInitialSiblingRect.left + 1,
    ...
    it('should toggle a class when dragging an item inside a wrapper component component ' +
       ...
       fakeAsync(() => {
         ...
         expect(startZone.classList)
             .not.toContain(
                 'cdk-drop-list-dragging', 'Expected start not to have dragging class on init.');
         expect(targetZone.classList)
             .not.toContain(
                 'cdk-drop-list-dragging', 'Expected target not to have dragging class on init.');
    ...
    it('should dispatch an event when an item enters a new container', fakeAsync(() => {
         ...
         const containerEnterEvent =
             fixture.componentInstance.enteredSpy.calls.mostRecent().args[0];
    ...
    it('should be able to drop into a new container inside the Shadow DOM', fakeAsync(() => {
         ...
         const fixture =
             createComponent(ConnectedDropZones, [], undefined, [], ViewEncapsulation.ShadowDom);
         fixture.detectChanges();
    ...
    it('should warn when the connected container ID does not exist', fakeAsync(() => {
         ...
         expect(console.warn)
             .toHaveBeenCalledWith(
                 `CdkDropList could not find connected drop ` +
...
class DraggableInDropZone implements AfterViewInit {
  ...
  items = [
    {value: 'Zero', height: ITEM_HEIGHT, margin: 0}, {value: 'One', height: ITEM_HEIGHT, margin: 0},
    {value: 'Two', height: ITEM_HEIGHT, margin: 0}, {value: 'Three', height: ITEM_HEIGHT, margin: 0}
  ];
  dropZoneId = 'items';
...
class DraggableInHorizontalDropZone implements AfterViewInit {
  ...
  @ViewChild(CdkDropList) dropInstance: CdkDropList;
  items = [
    {value: 'Zero', width: ITEM_WIDTH, margin: 0}, {value: 'One', width: ITEM_WIDTH, margin: 0},
    {value: 'Two', width: ITEM_WIDTH, margin: 0}, {value: 'Three', width: ITEM_WIDTH, margin: 0}
  ];
  boundarySelector: string;
  droppedSpy = jasmine.createSpy('dropped spy').and.callFake((event: CdkDragDrop<string[]>) => {
    moveItemInArray(this.items, event.previousIndex, event.currentIndex);
...
class DraggableInDropZoneWithoutEvents {
  ...
  @ViewChild(CdkDropList) dropInstance: CdkDropList;
  items = [
    {value: 'Zero', height: ITEM_HEIGHT}, {value: 'One', height: ITEM_HEIGHT},
    {value: 'Two', height: ITEM_HEIGHT}, {value: 'Three', height: ITEM_HEIGHT}
  ];
}
 ...
 */
@Component({selector: 'passthrough-component', template: '<ng-content></ng-content>'})
...
@Component({template: `<div cdkDrag></div>`})
class PlainStandaloneDraggable {
  @ViewChild(CdkDrag) dragInstance: CdkDrag;
}

@Component({template: `<div cdkDropList></div>`})
 ...
 */
function makeScrollable(direction: 'vertical'|'horizontal' = 'vertical', element = document.body) {
