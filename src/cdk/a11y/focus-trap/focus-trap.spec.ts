...
describe('FocusTrap', () => {
  ...
  describe('with bindings', () => {
    ...
    it('should set the appropriate tabindex on the anchors, based on the disabled state', () => {
      const anchors = Array.from(fixture.debugElement.nativeElement.querySelectorAll(
                          'div.cdk-visually-hidden')) as HTMLElement[];
...
@Component({template: AUTO_FOCUS_TEMPLATE, encapsulation: ViewEncapsulation.ShadowDom})
