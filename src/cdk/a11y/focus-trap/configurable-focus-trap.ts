...
export class ConfigurableFocusTrap extends FocusTrap implements ManagedFocusTrap {
  ...
  constructor(
      _element: HTMLElement, _checker: InteractivityChecker, _ngZone: NgZone, _document: Document,
      private _focusTrapManager: FocusTrapManager, private _inertStrategy: FocusTrapInertStrategy,
