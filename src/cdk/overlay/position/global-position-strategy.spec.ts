...
import {Overlay, OverlayConfig, OverlayModule, OverlayRef} from '../index';
...
describe('GlobalPositonStrategy', () => {
  ...
  it('should position the element to the (top, left) with an offset', () => {
    attachOverlay({positionStrategy: overlay.position().global().top('10px').left('40px')});
  ...
  it('should position the element to the (bottom, right) with an offset', () => {
    attachOverlay({positionStrategy: overlay.position().global().bottom('70px').right('15em')});
  ...
  it('should center the element with an offset', () => {
    attachOverlay({
      positionStrategy:
          overlay.position().global().centerHorizontally('10px').centerVertically('15px')
    });
  ...
  it('should make the element position: static', () => {
    attachOverlay({positionStrategy: overlay.position().global()});
  ...
  it('should set the element width', () => {
    attachOverlay({positionStrategy: overlay.position().global().width('100px')});

    expect(overlayRef.overlayElement.style.width).toBe('100px');
  });

  it('should set the element height', () => {
    attachOverlay({positionStrategy: overlay.position().global().height('100px')});
  ...
  it('should take its width and height from the overlay config', () => {
    attachOverlay({positionStrategy: overlay.position().global(), width: '500px', height: '300px'});
  ...
  it('should invert `justify-content` when using `left` in RTL', () => {
    attachOverlay({positionStrategy: overlay.position().global().left('0'), direction: 'rtl'});
  ...
  it('should invert `justify-content` when using `right` in RTL', () => {
    attachOverlay({positionStrategy: overlay.position().global().right('0'), direction: 'rtl'});
