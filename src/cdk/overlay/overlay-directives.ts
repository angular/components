...
export class CdkConnectedOverlay implements OnDestroy, OnChanges {
  ...
  set hasBackdrop(value: BooleanInput) { this._hasBackdrop = coerceBooleanProperty(value); }

  /** Whether or not the overlay should be locked when scrolling. */
  @Input('cdkConnectedOverlayLockPosition')
  get lockPosition(): boolean { return this._lockPosition; }
  set lockPosition(value: BooleanInput) { this._lockPosition = coerceBooleanProperty(value); }

  /** Whether the overlay's width and height can be constrained to fit within the viewport. */
  @Input('cdkConnectedOverlayFlexibleDimensions')
  get flexibleDimensions(): boolean { return this._flexibleDimensions; }
  ...
  get growAfterOpen(): boolean { return this._growAfterOpen; }
  set growAfterOpen(value: BooleanInput) { this._growAfterOpen = coerceBooleanProperty(value); }

  /** Whether the overlay can be pushed on-screen if none of the provided positions fit. */
  @Input('cdkConnectedOverlayPush')
  get push(): boolean { return this._push; }
  set push(value: BooleanInput) { this._push = coerceBooleanProperty(value); }
