...
export const constructorChecks: VersionChanges<ConstructorChecksUpgradeData> = {
  [TargetVersion.V12]: [
    {pr: 'https://github.com/angular/components/pull/21876', changes: ['CdkTable', 'StickyStyler']},
    {pr: 'https://github.com/angular/components/issues/21900', changes: ['CdkStepper']}
  ],
  [TargetVersion.V11]: [
    {
    ...
    {pr: 'https://github.com/angular/components/pull/20500', changes: ['CdkDropList']},
    {pr: 'https://github.com/angular/components/pull/20572', changes: ['CdkTreeNodePadding']}, {
      pr: 'https://github.com/angular/components/pull/20511',
      changes: ['OverlayContainer', 'FullscreenOverlayContainer', 'OverlayRef', 'Overlay']
    }
  ],
  [TargetVersion.V10]:
      [{pr: 'https://github.com/angular/components/pull/19347', changes: ['Platform']}],
  [TargetVersion.V9]:
      [{pr: 'https://github.com/angular/components/pull/17084', changes: ['DropListRef']}],
  [TargetVersion.V8]: [{
