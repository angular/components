  ...
  visitStylesheet(stylesheet: ResolvedResource): void {
    this.data.forEach(name => {
      ...
      findAllSubstringIndices(stylesheet.content, currentSelector)
        ...
        .forEach(start => this._replaceInputName(stylesheet.filePath, start,
            currentSelector.length, updatedSelector));
    });
  }
  ...
  visitTemplate(template: ResolvedResource): void {
    this.data.forEach(name => {
      ...
      relativeOffsets
        ...
        .forEach(start => this._replaceInputName(template.filePath, start,
