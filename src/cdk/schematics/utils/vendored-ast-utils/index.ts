 ...
 * Taken from:
 *   (1)
 * https://github.com/angular/angular-cli/blob/30df1470a0f18989db336d50b55a79021ab64c85/packages/schematics/angular/utility/ng-ast-utils.ts
 *   (2)
 * https://github.com/angular/angular-cli/blob/30df1470a0f18989db336d50b55a79021ab64c85/packages/schematics/angular/utility/ast-utils.ts
 */
...
export function insertImport(
    source: ts.SourceFile, fileToEdit: string, symbolName: string, fileName: string,
...
export function findNodes(
    node: ts.Node, kind: ts.SyntaxKind, max = Infinity, recursive = false): ts.Node[] {
  if (!node || max == 0) {
    return [];
  }
...
export function insertAfterLastOccurrence(
    nodes: ts.Node[], toInsert: string, file: string, fallbackPos: number,
...
function _angularImportsFromNode(
    node: ts.ImportDeclaration, _sourceFile: ts.SourceFile): {[name: string]: string} {
...
export function getDecoratorMetadata(
    source: ts.SourceFile, identifier: string, module: string): ts.Node[] {
...
export function addDeclarationToModule(
    source: ts.SourceFile, modulePath: string, classifiedName: string,
