 ...
 */
export class _RecycleViewRepeaterStrategy<T, R, C extends _ViewRepeaterItemContext<T>> implements
    _ViewRepeater<T, R, C> {
  /**
         ...
         currentIndex: number|null) => {
          ...
          if (record.previousIndex == null) {  // Item added.
            ...
            view = this._insertView(
                viewArgsFactory, currentIndex!, viewContainerRef, itemValueResolver(record));
            ...
            view = this._moveView(
                adjustedPreviousIndex!, currentIndex!, viewContainerRef, itemValueResolver(record));
   ...
   */
  private _insertView(
      viewArgsFactory: () => _ViewRepeaterItemInsertArgs<C>, currentIndex: number,
      viewContainerRef: ViewContainerRef, value: T): EmbeddedViewRef<C>|undefined {
  ...
  private _moveView(
      adjustedPreviousIndex: number, currentIndex: number, viewContainerRef: ViewContainerRef,
      value: T): EmbeddedViewRef<C> {
  ...
  private _insertViewFromCache(index: number, viewContainerRef: ViewContainerRef):
