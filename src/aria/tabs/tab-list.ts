...
import {TABS, TAB_LIST_COLLECTION, TAB_LIST} from './tab-tokens';
...
@Directive({
  ...
  providers: [
    {provide: TAB_LIST, useExisting: TabList},
    {provide: TAB_LIST_COLLECTION, useFactory: () => inject(TabList)._collection},
  ],
})
