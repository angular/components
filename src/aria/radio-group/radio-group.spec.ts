...
describe('RadioGroup', () => {
  ...
  let radioGroupInstance: RadioGroup<number>;
  ...
  function defineTestVariables(fixture: ComponentFixture<unknown>) {
    radioGroup = fixture.debugElement.query(By.directive(RadioGroup));
    radioButtons = fixture.debugElement.queryAll(By.directive(RadioButton));
    radioGroupInstance = radioGroup.injector.get<RadioGroup<number>>(RadioGroup);
