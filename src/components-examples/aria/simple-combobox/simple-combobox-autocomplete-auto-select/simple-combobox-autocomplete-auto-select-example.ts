...
@Component({
  selector: 'simple-combobox-autocomplete-auto-select-example',
  templateUrl: 'simple-combobox-autocomplete-auto-select-example.html',
  styleUrl: '../autocomplete.css',
  imports: [Combobox, ComboboxPopup, ComboboxWidget, Listbox, Option, OverlayModule, FormsModule],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SimpleComboboxAutocompleteAutoSelectExample {
