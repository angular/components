...
/** @title Simple Combobox Autocomplete with manual filtering. */
@Component({
  selector: 'simple-combobox-autocomplete-manual-example',
  templateUrl: 'simple-combobox-autocomplete-manual-example.html',
  styleUrl: '../autocomplete.css',
  imports: [Combobox, ComboboxPopup, ComboboxWidget, Listbox, Option, OverlayModule, FormsModule],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SimpleComboboxAutocompleteManualExample {
