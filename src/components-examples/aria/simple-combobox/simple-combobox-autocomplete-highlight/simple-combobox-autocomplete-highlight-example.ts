...
@Component({
  selector: 'simple-combobox-autocomplete-highlight-example',
  templateUrl: 'simple-combobox-autocomplete-highlight-example.html',
  styleUrl: '../autocomplete.css',
  imports: [Combobox, ComboboxPopup, ComboboxWidget, Listbox, Option, OverlayModule, FormsModule],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SimpleComboboxAutocompleteHighlightExample {
