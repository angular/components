...
@Component({
  selector: 'simple-combobox-readonly-multiselect-example',
  templateUrl: 'simple-combobox-readonly-multiselect-example.html',
  styleUrl: '../simple-combobox-examples.css',
  imports: [Combobox, ComboboxPopup, ComboboxWidget, Listbox, Option, OverlayModule],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SimpleComboboxReadonlyMultiselectExample {
  ...
  onCommit() {
    // For multiselect, we usually keep the popup open or close on explicit action.
    // In Full-combobox example, clicking options just toggles.
  }
}
