 ...
 */
@Component({
  selector: 'cdk-listbox-multi-select-follow-focus-example',
  exportAs: 'cdkListboxMultiSelectFollowFocusExample',
  templateUrl: 'cdk-listbox-multi-select-follow-focus-example.html',
  styleUrl: '../cdk-listbox-configurable/cdk-listbox-configurable-example.css',
  standalone: true,
  imports: [CdkListbox, CdkOption, MatPseudoCheckbox],
})
export class CdkListboxMultiSelectFollowFocusExample {
  fruits = [
    'Apple',
    'Apricot',
    'Banana',
