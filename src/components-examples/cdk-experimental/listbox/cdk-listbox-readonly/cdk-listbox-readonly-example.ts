 ...
 */
@Component({
  selector: 'cdk-listbox-readonly-example',
  exportAs: 'cdkListboxReadonlyExample',
  templateUrl: 'cdk-listbox-readonly-example.html',
  styleUrl: '../cdk-listbox-configurable/cdk-listbox-configurable-example.css',
  standalone: true,
  imports: [CdkListbox, CdkOption, MatPseudoCheckbox],
})
export class CdkListboxReadonlyExample {
  fruits = [
    'Apple',
    'Apricot',
    'Banana',
