...
@Directive()
/** @docs-private */
export abstract class MatInteractiveListBase<T extends MatListItemBase> extends MatListBase
...
export function getInteractiveListAdapter(list: MatInteractiveListBase<MatListItemBase>):
    MDCListAdapter {
  return {
    getListItemCount() {
