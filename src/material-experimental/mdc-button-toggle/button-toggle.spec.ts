...
describe('MatButtonToggle with forms', () => {
  ...
  it('should be able to pick up toggles that are not direct descendants', fakeAsync(() => {
    ...
    const button = fixture.nativeElement.querySelector('.mat-mdc-button-toggle');
...
describe('MatButtonToggle without forms', () => {
 ...
 describe('inside of an exclusive selection group', () => {
    ...
    beforeEach(() => {
      ...
      buttonToggleLabelElements = fixture.debugElement.queryAll(By.css('.mdc-button-toggle__label'))
        .map(debugEl => debugEl.nativeElement);
    ...
    it('should disable the underlying button when the group is disabled', () => {
      expect(buttonToggleNativeElements.every(input => input.disabled)).toBe(false);

      testComponent.isGroupDisabled = true;
      fixture.detectChanges();

      expect(buttonToggleNativeElements.every(input => input.disabled)).toBe(true);
    });
   ...
   it('should have correct role for group and toggles', () => {
     expect(groupNativeElement.getAttribute('role')).toBe('radiogroup');
     expect(buttonToggleNativeElements.every(button => button.getAttribute('role') === 'radio'))
       .toBe(true);
   });
 });
  ...
  describe('inside of a multiple selection group', () => {
    ...
    it('should check a button toggle when clicked', () => {
      ...
      let button = buttonToggleNativeElements[0];
    ...
    it('should have correct role for group and toggles', () => {
      expect(groupNativeElement.getAttribute('role')).toBe('group');
      expect(buttonToggleNativeElements.every(button => button.hasAttribute('role'))).toBe(false);
    });
  });
  ...
  describe('as standalone', () => {
    ...
    beforeEach(fakeAsync(() => {
      ...
      buttonToggleLabelElement = fixture.debugElement
        .query(By.css('.mdc-button-toggle__label'))!.nativeElement;
    ...
    it('should focus on underlying input element when focus() is called', () => {
      expect(document.activeElement).not.toBe(buttonToggleNativeElement);

      buttonToggleInstance.focus();
      fixture.detectChanges();

      expect(document.activeElement).toBe(buttonToggleNativeElement);
    });

    it('should not assign a name to the underlying input if one is not passed in', () => {
      expect(buttonToggleNativeElement.getAttribute('name')).toBeFalsy();
    });

    it('should have correct aria-pressed attribute', () => {
      expect(buttonToggleNativeElement.getAttribute('aria-pressed'))
        .toBe('false');
  ...
  describe('aria-label handling ', () => {
    it('should not set the aria-label attribute if none is provided', () => {
      ...
      let buttonToggleDebugElement = fixture.debugElement.query(By.directive(MatButtonToggle))!;
      let buttonElement = buttonToggleDebugElement.nativeElement;
  ...
  describe('with provided aria-labelledby ', () => {
    ...
    it('should use the provided aria-labelledby', () => {
      ...
      buttonToggleDebugElement = fixture.debugElement.query(By.directive(MatButtonToggle))!;
      buttonElement = buttonToggleDebugElement.nativeElement;
  ...
  it('should not throw on init when toggles are repeated and there is an initial value', () => {
    ...
    const hostNode: HTMLElement = fixture.nativeElement.querySelector('.mat-mdc-button-toggle');
  ...
  it('should not throw if initial value is set during creation', () => {
    ...
    expect(() => {
      const toggle = fixture.debugElement.query(
        By.css('.mat-mdc-button-toggle'))!.componentInstance;
      toggle.checked = true;
      fixture.detectChanges();
    }).not.toThrow();
  });
...
@Component({
  ...
  <mat-button-toggle-group [disabled]="isGroupDisabled"
                           [vertical]="isVertical"
                           [(value)]="groupValue">
    <button mat-button-toggle value="test1" *ngIf="renderFirstToggle">Test1</button>
    <button mat-button-toggle value="test2">Test2</button>
    <button mat-button-toggle value="test3">Test3</button>
...
@Component({
  ...
  <mat-button-toggle-group
    ...
    <button mat-button-toggle *ngFor="let option of options" [value]="option.value"
...
@Component({
  ...
  <mat-button-toggle-group [disabled]="isGroupDisabled" [vertical]="isVertical" multiple>
    <button mat-button-toggle value="eggs">Eggs</button>
    <button mat-button-toggle value="flour">Flour</button>
    <button mat-button-toggle value="sugar">Sugar</button>
  </mat-button-toggle-group>
  `
})
...
@Component({
  ...
  <mat-button-toggle-group multiple [value]="value">
    <button mat-button-toggle [value]="0">Eggs</button>
    <button mat-button-toggle [value]="null">Flour</button>
    <button mat-button-toggle [value]="false">Sugar</button>
    <button mat-button-toggle>Sugar</button>
  </mat-button-toggle-group>
  `
})
...
@Component({
  template: `
  <button mat-button-toggle>Yes</button>
  `
})
...
@Component({
  ...
  <mat-button-toggle-group (change)="lastEvent = $event" value="red">
    <button mat-button-toggle value="red">Value Red</button>
    <button mat-button-toggle value="green">Value Green</button>
  </mat-button-toggle-group>
  `
})
...
@Component({
  ...
  <mat-button-toggle-group [formControl]="control">
    <button mat-button-toggle value="red">Value Red</button>
    <button mat-button-toggle value="green">Value Green</button>
    <button mat-button-toggle value="blue">Value Blue</button>
  </mat-button-toggle-group>
  `
})
...
@Component({
  template: `<button mat-button-toggle aria-label="Super effective"></button>`
})
class ButtonToggleWithAriaLabel { }

/** Simple test component with an aria-label set. */
@Component({
  template: `<button mat-button-toggle aria-labelledby="some-id"></button>`
})
...
@Component({
  template: `
    <mat-button-toggle-group [(value)]="value">
      <button mat-button-toggle *ngFor="let toggle of possibleValues" [value]="toggle">
        {{toggle}}
      </button>
    </mat-button-toggle-group>
  `
...
@Component({
  template: `<button mat-button-toggle tabindex="3"></button>`
})
class ButtonToggleWithTabindex {}

@Component({
  template: `<button mat-button-toggle name="custom-name"></button>`
})
...
@Component({
  template: `
    <mat-button-toggle-group>
      ...
      <button mat-button-toggle value="2" checked>Two</button>
    </mat-button-toggle-group>
  `
})
...
@Component({
  template: `
    <button mat-button-toggle aria-label="Toggle me" aria-labelledby="something"></button>
  `
})
