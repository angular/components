...
describe('MDC-based MatTabGroup', () => {
  ...
  describe('basic behavior', () => {
    ...
    it('should emit focusChange event on click', () => {
      ...
      expect(fixture.componentInstance.handleFocus).toHaveBeenCalledWith(jasmine.objectContaining({
        index: 2
      }));
    });
    ...
    it('should emit focusChange on arrow key navigation', () => {
      ...
      const tabLabelContainer =
          fixture.debugElement.query(By.css('.mat-mdc-tab-label-container')).nativeElement as
          HTMLElement;
    ...
    it('should be able to set a tabindex on the inner content element', () => {
      ...
      const contentElements =
          Array.from<HTMLElement>(fixture.nativeElement.querySelectorAll('mat-tab-body'));
  ...
  function checkSelectedIndex(expectedIndex: number, fixture: ComponentFixture<any>) {
    ...
    let tabComponent: MatTabGroup =
        fixture.debugElement.query(By.css('mat-tab-group')).componentInstance;
    expect(tabComponent.selectedIndex).toBe(expectedIndex);

    let tabLabelElement =
        fixture.debugElement.query(By.css(`.mat-mdc-tab:nth-of-type(${expectedIndex + 1})`))
            .nativeElement;
    expect(tabLabelElement.classList.contains('mdc-tab--active')).toBe(true);

    let tabContentElement =
        fixture.debugElement.query(By.css(`mat-tab-body:nth-of-type(${expectedIndex + 1})`))
            .nativeElement;
