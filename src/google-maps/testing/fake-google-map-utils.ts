...
export function createMapConstructorSpy(
  ...
  const mapConstructorSpy = jasmine.createSpy(
    'Map constructor',
    (_el: Element, _options: google.maps.MapOptions) => {
      return mapSpy;
    },
  );
...
export function createMarkerConstructorSpy(
  ...
  const markerConstructorSpy = jasmine.createSpy(
    'Marker constructor',
...
export function createInfoWindowConstructorSpy(
  ...
  const infoWindowConstructorSpy = jasmine.createSpy(
...
export function createPolylineConstructorSpy(
  ...
  const polylineConstructorSpy = jasmine.createSpy(
    'Polyline constructor',
    (_options: google.maps.PolylineOptions) => {
      return polylineSpy;
    },
  );
  const testingWindow: TestingWindow = window;
...
export function createPolygonConstructorSpy(
  ...
  const polygonConstructorSpy = jasmine.createSpy(
    'Polygon constructor',
    (_options: google.maps.PolygonOptions) => {
      return polygonSpy;
    },
  );
  const testingWindow: TestingWindow = window;
...
export function createRectangleConstructorSpy(
  ...
  const rectangleConstructorSpy = jasmine.createSpy(
    'Rectangle constructor',
    (_options: google.maps.RectangleOptions) => {
      return rectangleSpy;
    },
  );
  const testingWindow: TestingWindow = window;
...
export function createCircleConstructorSpy(
  ...
  const circleConstructorSpy = jasmine.createSpy(
    'Circle constructor',
    (_options: google.maps.CircleOptions) => {
      return circleSpy;
    },
  );
  const testingWindow: TestingWindow = window;
...
export function createGroundOverlayConstructorSpy(
  ...
  const groundOverlayConstructorSpy = jasmine.createSpy(
    ...
    (
      _url: string,
      _bounds: google.maps.LatLngBoundsLiteral,
...
export function createKmlLayerConstructorSpy(
  ...
  const kmlLayerConstructorSpy = jasmine.createSpy(
    'KmlLayer constructor',
    (_options: google.maps.KmlLayerOptions) => {
      return kmlLayerSpy;
    },
  );
  const testingWindow: TestingWindow = window;
...
export function createTrafficLayerConstructorSpy(
  ...
  const trafficLayerConstructorSpy = jasmine.createSpy(
    'TrafficLayer constructor',
    (_options: google.maps.TrafficLayerOptions) => {
      return trafficLayerSpy;
    },
  );
  const testingWindow: TestingWindow = window;
