...
import {CdkToolbar, CdkToolbarWidget, CdkToolbarWidgetGroup} from './toolbar';
...
describe('CdkToolbar', () => {
  ...
  function setupTestToolbar(textDirection: Direction = 'ltr') {
    TestBed.configureTestingModule({
      imports: [CdkToolbar, CdkToolbarWidget, CdkToolbarWidgetGroup, TestToolbarComponent],
  ...
  function defineTestVariables() {
    const toolbarDebugElement = fixture.debugElement.query(By.directive(CdkToolbar));
  ...
  describe('ARIA attributes and roles', () => {
    describe('default configuration', () => {
      ...
      it('should correctly set the role attribute to "toolbar" for CdkToolbar', () => {
...
class TestToolbarWidgetGroup {
  ...
  constructor() {
    ...
    this.cdkToolbarWidgetGroup.actions.set({
      next: wrap => {
      ...
      asEntryPoint: () => {
        this.lastAction.set('asEntryPoint');
      },
    });
  }
}
...
@Component({
  ...
  `,
  imports: [CdkToolbar, CdkToolbarWidget, CdkToolbarWidgetGroup, TestToolbarWidgetGroup],
})
