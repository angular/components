...
export class TreeItemPattern<V> implements ExpansionItem {
  ...
  constructor(readonly inputs: TreeItemInputs<V>) {
    ...
    this.expandable = inputs.hasChilren;
...
export class TreePattern<V> {
  ...
  /** All currently visible/expanded tree items. */
  ...
  /** The key for collapsing a node or moving to its parent. */
  ...
  /** The key for expanding a node or moving to its first child. */
