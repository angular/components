...
type TestInputs = Partial<ListSelectionInputs<TestItem, number> & ListFocusInputs<TestItem>> & {
  numItems?: number;
};

function getSelection(inputs: TestInputs = {}): ListSelection<TestItem, number> {
...
describe('List Selection', () => {
  describe('#select', () => {
    ...
    it('should select multiple options', () => {
      ...
      const items = selection.inputs.focusManager.inputs.items();
