...
describe('Dialog', () => {
  ...
  beforeEach(inject(
      [Dialog, Location, OverlayContainer], (d: Dialog, l: Location, o: OverlayContainer) => {
        dialog = d;
  ...
  it('should open a dialog with a template', () => {
    ...
    let dialogRef =
        dialog.openFromTemplate(templateRefFixture.componentInstance.templateRef, {data});
  ...
  it('should close from a ViewContainerRef with OnPush change detection', fakeAsync(() => {
       ...
       const dialogRef = dialog.openFromComponent(
  ...
  it('should notify the observers if all open dialogs have finished closing', fakeAsync(() => {
       ...
       const ref2 =
           dialog.openFromComponent(ContentElementDialog, {viewContainerRef: testViewContainerRef});
  ...
  it('should override the width of the overlay pane', () => {
    dialog.openFromComponent(PizzaMsg, {width: '500px'});
  ...
  it('should override the height of the overlay pane', () => {
    dialog.openFromComponent(PizzaMsg, {height: '100px'});
  ...
  it('should override the min-width of the overlay pane', () => {
    dialog.openFromComponent(PizzaMsg, {minWidth: '500px'});
  ...
  it('should override the max-width of the overlay pane', fakeAsync(() => {
       ...
       dialogRef = dialog.openFromComponent(PizzaMsg, {maxWidth: '100px'});
  ...
  it('should override the min-height of the overlay pane', () => {
    dialog.openFromComponent(PizzaMsg, {minHeight: '300px'});
  ...
  it('should override the max-height of the overlay pane', () => {
    dialog.openFromComponent(PizzaMsg, {maxHeight: '100px'});
  ...
  it('should override the top offset of the overlay pane', () => {
    dialog.openFromComponent(PizzaMsg, {position: {top: '100px'}});
  ...
  it('should override the bottom offset of the overlay pane', () => {
    dialog.openFromComponent(PizzaMsg, {position: {bottom: '200px'}});
  ...
  it('should override the left offset of the overlay pane', () => {
    dialog.openFromComponent(PizzaMsg, {position: {left: '250px'}});
  ...
  it('should override the right offset of the overlay pane', () => {
    dialog.openFromComponent(PizzaMsg, {position: {right: '125px'}});
  ...
  it('should allow for the position to be updated', () => {
    let dialogRef = dialog.openFromComponent(PizzaMsg, {position: {left: '250px'}});
  ...
  it('should set the proper animation states', () => {
    ...
    let dialogContainer: CdkDialogContainer =
        viewContainerFixture.debugElement.query(
                                             By.directive(CdkDialogContainer))!.componentInstance;
  ...
  describe('disableClose option', () => {
    it('should prevent closing via clicks on the backdrop', fakeAsync(() => {
         dialog.openFromComponent(
             PizzaMsg, {disableClose: true, viewContainerRef: testViewContainerRef});
    ...
    it('should work when opening from a template', fakeAsync(() => {
         ...
         dialog.openFromTemplate(
             templateRefFixture.componentInstance.templateRef, {disableClose: true});
  ...
  describe('hasBackdrop option', () => {
    it('should have a backdrop', () => {
      dialog.openFromComponent(
          PizzaMsg, {hasBackdrop: true, viewContainerRef: testViewContainerRef});
    ...
    it('should not have a backdrop', () => {
      dialog.openFromComponent(
          PizzaMsg, {hasBackdrop: false, viewContainerRef: testViewContainerRef});
  ...
  describe('backdropClass option', () => {
    it('should have default backdrop class', () => {
      dialog.openFromComponent(
          PizzaMsg, {backdropClass: '', viewContainerRef: testViewContainerRef});
  ...
  describe('focus management', () => {
    ...
    it('should focus the dialog element on open', fakeAsync(() => {
         dialog.openFromComponent(
             PizzaMsg, {viewContainerRef: testViewContainerRef, autoFocus: 'dialog'});
    ...
    it('should focus the first header element on open', fakeAsync(() => {
         dialog.openFromComponent(
             ...
             {viewContainerRef: testViewContainerRef, autoFocus: 'first-heading'});
    ...
    it('should focus the first element that matches the css selector from autoFocus on open',
       fakeAsync(() => {
         dialog.openFromComponent(
             PizzaMsg, {viewContainerRef: testViewContainerRef, autoFocus: 'p'});
  ...
  describe('aria-label', () => {
    it('should be able to set a custom aria-label', () => {
      dialog.openFromComponent(
          PizzaMsg, {ariaLabel: 'Hello there', viewContainerRef: testViewContainerRef});
      viewContainerFixture.detectChanges();
...
class PizzaMsg {
  constructor(
      public dialogRef: DialogRef<PizzaMsg>, public dialogInjector: Injector,
...
@Component({template: '', providers: [Dialog]})
...
@Component({template: `<button>I'm a button</button>`, encapsulation: ViewEncapsulation.ShadowDom})
