...
task(
    ':test:build',
    series(
        'clean', 'cdk:build-no-bundles', 'material:build-no-bundles',
        'cdk-experimental:build-no-bundles', 'material-experimental:build-no-bundles',
        'youtube-player:build-no-bundles', 'material-moment-adapter:build-no-bundles',
        'material-luxon-adapter:build-no-bundles', 'material-date-fns-adapter:build-no-bundles',
        'google-maps:build-no-bundles', ':test:build-date-fns', ':test:build-system-config'));
